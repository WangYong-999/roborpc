...
class MultiRealMan(RobotBase):
    ...
    def set_ee_pose(self, action: Union[List[float], Dict[str, List[float]]],
                    action_space: Union[str, Dict[str, str]] = {"realman_1": "cartesian_position"},
                    blocking: Union[bool, Dict[str, bool]] = {"realman_1": False}):
    ...
    def set_joints(self, action: Union[List[float], Dict[str, List[float]]],
                   action_space: Union[str, Dict[str, str]] = {"realman_1": "joint_position"},
                   blocking: Union[bool, Dict[str, bool]] = {"realman_1": False}):
    ...
    def set_gripper(self, action: Union[List[float], Dict[str, List[float]]],
                    action_space: Union[str, Dict[str, str]] = {"realman_1": "gripper_position"},
                    blocking: Union[bool, Dict[str, bool]] = {"realman_1": False}):
    ...
    def get_robot_state(self) -> Dict[str, List[float]]:
        ...
        for robot_id, robot in self.robots.items():
            ...
            asyncio.ensure_future(robot_state[robot_id])
