...
from droid.utils.camera_utils.recording_readers.mp4_reader import MP4Reader
from droid.utils.camera_utils.recording_readers.svo_reader import SVOReader
...
class RecordedMultiCameraWrapper:
    ...
    def read_cameras(self, index=None, camera_type_dict={}, timestamp_dict={}):
        ...
        for cam_id in all_cam_ids:
            ...
            print(f"self.camera_dict:{self.camera_dict}")
