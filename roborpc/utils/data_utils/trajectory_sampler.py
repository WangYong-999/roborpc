...
from droid.utils.data_utils.timestep_processing import TimestepProcesser
from droid.utils.trajectory_utils.trajectory_utils import load_trajectory
...
def collect_data_folderpaths(filter_func=None, remove_failures=True):
    # Prepare Data Folder #
    data_dir = os.path.join(config["droid"]["collector"]["save_data_dir"])
    if remove_failures:
